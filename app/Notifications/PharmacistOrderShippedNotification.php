...
class PharmacistOrderShippedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('The order ' . $this->order->order_uid . ' has been shipped.')
            ->line('Order Details:')
            ...
            ->line('')
            ->line('Please ensure the order is shipped correctly and track the delivery status.')
